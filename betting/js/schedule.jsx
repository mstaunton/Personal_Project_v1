...
class Schedule extends React.Component {
	...
	render(){
		let schedules = [{league:'NFL', games: this.state.NFL_games}, {league:'NBA', games:this.state.NBA_games}, {league:'NHL', games:this.state.NHL_games}, {league:'MLB', games:this.state.MLB_games}]
		return (
			<div>
				...
				<div className="schedule">
					{schedules.map(item =>
	    			  	<League_Schedule key={item.league} games={item.games} />
	    			)}
				</div>
			</div>
		);
